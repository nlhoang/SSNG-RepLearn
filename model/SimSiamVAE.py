...
class PredictorEncoder2(nn.Module):
    def __init__(self, latent_dim, variable_dim):
        super(PredictorEncoder2, self).__init__()
        hidden_dim = latent_dim // 2
        self.fc1 = nn.Linear(latent_dim, hidden_dim)
        self.bn1 = nn.BatchNorm1d(hidden_dim)
        self.fc2 = nn.Linear(hidden_dim, hidden_dim)
        self.bn2 = nn.BatchNorm1d(hidden_dim)
        self.fc3 = nn.Linear(hidden_dim, variable_dim)
...
class PredictorDecoder2(nn.Module):
    def __init__(self, variable_dim, latent_dim):
        super(PredictorDecoder2, self).__init__()
        hidden_dim = latent_dim // 2
        self.fc1 = nn.Linear(variable_dim, hidden_dim)
        self.bn1 = nn.BatchNorm1d(hidden_dim)
        self.fc2 = nn.Linear(hidden_dim, hidden_dim)
        self.bn2 = nn.BatchNorm1d(hidden_dim)
...
class SimSiamVAE(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        kappa2 = 30 * F.softplus(self.predictor_kappa(z2)) + 1e-6

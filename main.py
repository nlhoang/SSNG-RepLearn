...
from model import BYOL, SimCLR, SimSiam, SimSiamVAE, SimSiamVI
...
def args_define():
    ...
    parser.add_argument('--interval-saved', type=int, default=50, help='interval for saving models')
...
if __name__ == "__main__":
    ...
    pretrained = True
    if pretrained:
        trained_model_path = 'experiments/SSNG_ImageNetHF100_400.pth'
